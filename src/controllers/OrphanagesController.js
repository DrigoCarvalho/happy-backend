...
const orphanages_view_2 = __importDefault(require("../views/orphanages_view"));
exports.default = {
    async index(request, response) {
        ...
        return response.json(orphanages_view_2.default.renderMany(orphanages));
    },
